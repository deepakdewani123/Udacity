...
var myBools = [true,false,true,false,true]
//: ## Array operations: count, insert, append, remove, retrieveWithSubscript
myBools.count
myBools.insert(false, atIndex: 5)
myBools.removeAtIndex(0)
myBools[1]
...
myDict = ["Anchovies":false,"Coconut":true,"Liver":true,"Cilantro":false]
//: ## Dictionary operations: count, insert, remove, update, retrieve with subscript
myDict.count
myDict["Apple"] = true
myDict["Liver"] = nil
myDict.updateValue(true, forKey: "Cilantro")
myDict["Coconut"]
//: ### Exercise 9
