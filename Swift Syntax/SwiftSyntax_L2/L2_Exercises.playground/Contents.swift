...
//    if let movies = moviesDict[movie] {
//        print(movies)
//    }
//}
//: ### Exercise 2
...
class LoginViewController: UIViewController {
    var textFieldForUserName : UITextField!
}
...
//if let tabBar = UITabBarController() //TODO: Optional chaining here {
...
if let painting = paintingDict["da Vinci"] {
...
if let vC = childViewController.parentViewController {
    print("VC has parentVC")
}
