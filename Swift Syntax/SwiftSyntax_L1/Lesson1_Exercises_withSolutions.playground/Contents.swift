...
let newSentence = "The \(nounArray[0]) jumped in the \(nounArray[2])"
let sillyString = "The \(nounArray[index1]) went to the \(nounArray[index2])"
...
//Solution
 shoutString = "HEY!" + " " + didYouKnowString.uppercaseString
//: ### Exercise 3
...
// var array = ["A", "13", "B","5","87", "t", "41"] // TODO: Choose constant or variable
// var sum = 0 // TODO: Choose constant or variable
// for String in array {
//     if String.toInt() != nil {
//         let intToAdd = String.toInt()! // TODO: Choose constant or variable
//         sum += intToAdd
//     }
// }
// println(sum)
